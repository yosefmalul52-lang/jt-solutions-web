  ...
  [
    {
      ...
      answer:
        "חבילת מיתוג לעסק ב-JT Solutions נעה בדרך כלל בין 4,500 ל-12,000 שקלים, בהתאם להיקף: לוגו בלבד, זהות ויזואלית מלאה, מדריך שימוש במותג ויישום בערוצים דיגיטליים. המחיר משקף תהליך מסודר — אפיון מותג, מספר כיוונים עיצוביים, סבבי דיוק וקבצים מוכנים לשימוש שוטף. מיתוג איכותי חוסך תיקונים יקרים באתר ובפרסום, ובונה אמון לפני כל קמפיין — השקעה שמחזירה את עצמה כשהלקוחות מזהים אתכם מיד.",
    },
    ...
    <>
      ...
      <main className="flex-1">
        <ServiceTemplate
          ...
          title="מיתוג לעסק — זהות ויזואלית שבונה אמון ובידול ברור"
