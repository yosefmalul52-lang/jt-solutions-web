      ...
      <main className="flex-1">
        ...
        >
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center" dir="rtl">
            <p className="text-xs font-semibold text-sky-600 mb-4">{page.regionLabel}</p>
              ...
              {page.servicesHighlight.map((slug) => {
                ...
                return (
                  <li key={slug}>
                    <Link
                      href={service.path}
                      className="premium-card block p-5 h-full hover:border-slate-300 transition-colors"
                    >
        ...
        <section className="pb-24 md:pb-32 bg-[#F8FAFC]">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center" dir="rtl">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              <CtaButton href="/contact" ctaLocation="areas-footer" shine="auto" />
              <CtaButton
                href="/projects"
            ...
            <p className="text-xs text-slate-500 mt-8">
              <Link href="/about" className="hover:text-cyan-300">אודות JT Solutions</Link>
              {" · "}
              <Link href="/blog" className="hover:text-cyan-300">מדריכים דיגיטל</Link>
            </p>
          </div>
        </section>
      </main>
