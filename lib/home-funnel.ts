import type { contactUrgencyOptions } from "@/lib/validation/contact";
...
export const problemSection = {
  ...
  subline:
    "אנחנו מחברים בין המותג, האתר, הקמפיינים, הפניות והמעקב, כך שכל חלק ממשיך את הקודם ועובד למטרה עסקית אחת.",
  insight:
  ...
  journeyClosingEyebrow: "התוצאה",
  journeyClosingHighlights: [
    { title: "ספק אחד", detail: "ליווי מקצה לקצה" },
    { title: "מעקב מלא", detail: "מקמפיין ועד סגירה" },
    { title: "שקיפות", detail: "יודעים מה עובד" },
  ],
  journeySteps: [
    {
      id: "site",
      index: "01",
      label: "אתר / דף נחיתה",
      description: "אתר מעוצב ונגיש לעסק שלך - כאן הגולשים מחליטים האם לפנות,להשאיר פרטים או לבצע רכישה",
      icon: "layout",
      color: "#2563EB",
      side: "right",
    },
    {
      ...
      index: "02",
      label: "קמפיין",
      description: "פרסום ממוקד בפלטפורומות של מטא או גוגל שמביא תנועה לנכס הדיגיטלי שלך. דרך ערוצים כמו פייסבוק, אינסטגרם, גוגל חיפוש, או יוטיוב",
      icon: "megaphone",
      color: "#F59E0B",
      side: "left",
    },
    {
      ...
      index: "03",
      label: "ליד",
      description: "הגולש משאיר פרטים באתר או בטופס הרשמות חיצוני - נוצרת פנייה חדשה.",
      icon: "user-plus",
      color: "#10B981",
      side: "right",
    },
    {
      ...
      index: "04",
      label: "דשבורד ניהול",
      description: "כל הפניות מתרכזות במקום אחד - רואים מי פנה, מתי ומאיפה.",
      icon: "message",
      color: "#7C3AED",
      side: "left",
      repair: true,
    },
    {
      ...
      index: "05",
      label: "מעקב ומדידה",
      description: "מעקב אחרי ביצועים וצמיחה - יודעים מה עובד ומה כדאי לשפר.",
      icon: "bell",
      color: "#06B6D4",
      side: "right",
      repair: true,
...
export const homePathways = [
  {
    id: "digital-start",
    name: "בסיס דיגיטלי מקצועי",
    forWho: "לעסק שצריך להתחיל נכון",
    description:
      "נבנה לעסק נראות מקצועית ומקום ברור שבו לקוחות יכולים להבין, להתרשם ולפנות.",
    items: [
      "אפיון המסר וההצעה",
      "מיתוג ונראות מקצועית",
      "אתר או דף נחיתה",
      "חיבור לטפסים ולוואטסאפ",
      "מדידה בסיסית",
    ],
    ctaLabel: "בואו נבנה את הבסיס",
    ctaLocation: "pathway-digital-start",
    ctaHref: "/?service=landing#contact",
  },
  {
    id: "ready-to-advertise",
    name: "מערכת מוכנה לשיווק",
    forWho: "לעסק שרוצה להתחיל לפרסם",
    description:
      "נחבר בין האתר, הקמפיינים והמדידה, כדי שתדעו מאיפה מגיעות הפניות ומה באמת עובד.",
    items: [
      "אתר או דף ממוקד פניות",
      "חיבור מערכות הפרסום",
      "ליווי קמפיינים ומעקב אחריהן",
      "הגדרת מדידה והמרות",
    ],
    popular: true,
    ctaLabel: "בואו נחבר את המערכת",
    ctaLocation: "pathway-advertise",
    ctaHref: "/?service=website#contact",
  },
  {
    id: "leads-system",
    name: "מערכת דיגיטלית אחת שמחברת את כל העסק",
    forWho: "לעסק שרוצה לנהל הכול במקום אחד",
    description:
      "נחבר את האתר, הקמפיינים, הפניות והאוטומציות למערכת מסודרת שעובדת יחד.",
    items: [
      "חיבור כל מקורות הפנייה",
      "CRM או מערכת ניהול מותאמת",
      "אוטומציות ומעקב אחרי לידים",
      "מדידה ושיפור התהליך",
    ],
    ctaLabel: "נכין את העסק לפרסום",
...
export const finalCtaSection = {
  before: "לא בטוחים מאיפה להתחיל? בואו ",
  accent: "נעשה סדר",
  after: "",
  accentColor: "#2563EB",
  subline:
    "אבחון דיגיטלי קצר שבו נבדוק את המותג, האתר, השיווק, ניהול הפניות והאוטומציות, ונבנה סדר פעולות שמתאים לעסק שלכם",
} as const;
...
export const finalCtaServiceChips = [
  {
    label: "אני רוצה אתר מכירות",
    value: "אני רוצה חנות אונליין",
    color: "#2563EB",
  },
  {
    label: "אני רוצה דף נחיתה לקמפיין",
    value: "אני צריך דף נחיתה לקמפיין",
    color: "#06B6D4",
  },
  {
    label: "אני עדיין לא בטוח/ה..",
    value: "אני עדיין לא בטוח..",
    color: "#7C3AED",
  },
  {
    label: "אני רוצה לבנות את המותג שלי",
    value: "אני רוצה לבנות את המותג שלי",
    color: "#10B981",
  },
] as const satisfies ReadonlyArray<{
  label: string;
  value: (typeof contactUrgencyOptions)[number];
  color: string;
}>;
