...
export const problemSection = {
  ...
  journeyClosing: "כשהחיבור בין כל השלבים ברור — כל פנייה מגיעה למקום הנכון. סוף סוף.",
  journeySteps: [
    {
      id: "campaign",
      index: "01",
      ...
      micro: "כאן נכנסת תנועה. בלי פרסום ממוקד, פחות אנשים בכלל מגיעים לראות מה אתה מציע.",
      color: "#F59E0B",
      side: "right",
    },
    {
      ...
      micro: "כאן הוא מחליט אם לפנות. מסר מבולגן, כפתור לא ברור או דף איטי? הוא פשוט עוזב.",
      color: "#2563EB",
      side: "left",
    },
    {
    ...
    },
    {
      ...
      micro: "כאן הרבה עסקים מאבדים לקוחות: אין סדר, אין תזכורת — ואף אחד לא יודע מי כבר קיבל מענה. מוכר?",
      color: "#EF4444",
      side: "left",
      isBreak: true,
    },
...
export const finalCtaServiceChips = [
  ...
  { label: "לא בטוח — צריך הכוונה", color: "#10B981" },
] as const;
