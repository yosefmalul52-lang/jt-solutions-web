export const identificationSection = {
  headline: "אם זה נשמע מוכר? — האתר שלך צריך לעבוד אחרת!",
  cards: [
    {
...
export const problemSection = {
  ...
  journeyClosing: "כשהחיבור ברור — כל פנייה מקבלת המשך.",
  journeySteps: [
    {
      id: "campaign",
      index: "01",
      label: "קמפיין",
      description: "תנועה נכנסת לעסק",
      color: "#F59E0B",
      side: "right",
    },
    {
      ...
      index: "02",
      label: "אתר / דף נחיתה",
      description: "מסר, CTA וטופס פנייה",
      color: "#2563EB",
      side: "left",
    },
    {
    ...
    },
    {
      ...
      index: "04",
      label: "נקודת נתק",
      description: "כאן הרבה פניות הולכות לאיבוד",
      color: "#EF4444",
      side: "left",
      isBreak: true,
    },
    {
      ...
      index: "05",
      label: "וואטסאפ / CRM",
      description: "הפנייה נכנסת למקום מסודר",
      color: "#7C3AED",
      side: "right",
      repair: true,
    },
    {
      ...
      index: "06",
      label: "מעקב",
      description: "תזכורת חזרה והמשך טיפול",
      color: "#06B6D4",
      side: "left",
      repair: true,
    },
    {
      ...
      index: "07",
      label: "מדידה",
      description: "מבינים מה באמת עובד",
      color: "#10B981",
      side: "right",
      repair: true,
    },
