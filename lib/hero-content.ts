...
export const heroCopy = {
  h1Line1: "לא עוד אתר יפה —",
  h1Line2: "מערכת דיגיטלית שמחברת קמפיינים לפניות מסודרות",
  subline:
    "בונים לך אתר או דף נחיתה, קמפיינים, מדידה, וואטסאפ, CRM ואוטומציות — כדי שתדע בדיוק מאיפה כל ליד הגיע, מי מחכה לחזרה ומה באמת עובד.",
  sublineMobile:
    "אתר, קמפיינים, מדידה, וואטסאפ ו-CRM במעטפת אחת — כדי שכל פנייה תיכנס מסודר, ולא תלך לאיבוד בדרך.",
  ctaLabel: "בוא נבדוק יחד — אבחון חינם",
