...
export const heroCopy = {
  ...
  subline:
    "JT Solutions בונה לעסקים בישראל אתר או דף נחיתה, קמפיינים, מדידה, וואטסאפ, CRM ואוטומציות — כדי שתדע מאיפה כל ליד הגיע, מי צריך חזרה ומה באמת עובד.",
  sublineMobile:
    "אתר, קמפיינים, מדידה, וואטסאפ ו-CRM במעטפת אחת — כדי שכל פנייה תיכנס מסודר ותהיה מוכנה למעקב.",
